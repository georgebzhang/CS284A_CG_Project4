...
void ClothSimulator::loadCloth(Cloth *cloth) {
	this->cloth = cloth;
	std::cout << cloth->springs[0].pm_a->position << std::endl;
}
...
void ClothSimulator::drawWireframe(GLShader &shader) {
  ...
  //std::cout << "cp->enable_structural_constraints: " << cp->enable_structural_constraints << std::endl;
  //std::cout << "cp->enable_shearing_constraints: " << cp->enable_shearing_constraints << std::endl;
  //std::cout << "cp->enable_bending_constraints: " << cp->enable_bending_constraints << std::endl;
  ...
  for (int i = 0; i < cloth->springs.size(); i++) {
	...
	//std::cout << s.spring_type << std::endl;
	...
	// debug, pm_a halfedge nullptr
	//std::cout << (s.pm_a->halfedge == nullptr) << std::endl;
	//std::cout << (s.pm_b->halfedge == nullptr) << std::endl;
	//std::cin.get();

	//if (s.pm_a->halfedge == nullptr) {
	//	std::cout << "pm_a halfedge null" << std::endl;
	//	std::cout << s.pm_a->position << std::endl;
	//	continue;
	//}
	//if (s.pm_b->halfedge == nullptr) {
	//	std::cout << "pm_b halfedge null" << std::endl;
	//	std::cout << s.pm_b->position << std::endl;
	//	std::cout << s.pm_b->last_position << std::endl;
	//	std::cout << s.pm_b->start_position << std::endl;
	//	continue;
	//}
	//std::cin.get();
