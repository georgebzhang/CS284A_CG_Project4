...
int main(int argc, char **argv) {
  ...
  cloth.buildGrid();
  //std::cout << "in main: " << cloth.springs.size() << std::endl;
  //std::cout << "in main: " << cloth.point_masses.size() << std::endl;
  //std::cout << "in main: " << &(cloth.springs[0].pm_a) << std::endl;
  //std::cout << "in main: " << &(cloth.springs[0].pm_a->position) << std::endl;
  //std::cout << "in main: " << cloth.springs[0].pm_a->position << std::endl;
  //std::cout << "in main: " << cloth.point_masses[0].position << std::endl;
  //for (int i = 0; i < cloth.point_masses.size(); ++i) {
	 // std::cout << "in main, point_masses: " << cloth.point_masses[i].position << std::endl;
  //}
  //for (int i = 0; i < cloth.springs.size(); ++i) {
	 // std::cout << "in main, springs: " << cloth.springs[i].pm_a->position << std::endl;
  //}
